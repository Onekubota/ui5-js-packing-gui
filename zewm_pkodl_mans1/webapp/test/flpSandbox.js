		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Pack Outbound Deliveries",
									"targetURL": "#zscmewmpackoutbdlvs1zewmpkodlmans1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zscmewmpackoutbdlvs1zewmpkodlmans1-display": {
								"semanticObject": "zscmewmpackoutbdlvs1zewmpkodlmans1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zscm.ewm.packoutbdlvs1",
									"url": sap.ui.require.toUrl("zscm/ewm/packoutbdlvs1/zewmpkodlmans1")
								}
							}
						}
					}
